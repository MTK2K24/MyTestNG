...
public class WaitUtility {
	public static final long EXPLICITWAIT = 80;
	...
	public WebElement fluentWaitForElement(By locator, WebDriver driver) {
		Wait<WebDriver> wait = new FluentWait<>(driver).withTimeout(Duration.ofSeconds(FLUENTWAIT_TIMEOUT))
				.pollingEvery(Duration.ofSeconds(FLUENTWAIT_POLLING)).ignoring(Exception.class);
