...
public class AdminActiveUserPage {
     ...
     @FindBy(xpath="//a[@class='btn btn-sm btn btn-success btncss']") private  WebElement greenlockicon;
     @FindBy(xpath="//a[@class='btn btn-sm btn-danger btn-rounded']") private  WebElement redlockicon;
     @FindBy(xpath="//div[@class='alert alert-success alert-dismissible']") private  WebElement sucessmessage;
