...
public class AdminTestActiveUser extends Base {
	@Test(groups = {
			"Regression" }, retryAnalyzer = retry.Retry.class, description = "This test case is to verify if a locked user can be unlocked")
	public void verifyIfAnAdminUserCanBeUnlocked() {
		...
		String successtext = ExcelUtility.getString(1, 3, "AdminActiveUser");
		...
		boolean successAlertDisplay = adminactiveuserpage.showSuccessMessage().contains(successtext);
